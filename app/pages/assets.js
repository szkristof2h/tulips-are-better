...
const metaAssets = () => {
  return [
    ...
    { name: 'description', content: 'A site for posting your stories online.' },
    ...
    { name: 'apple-mobile-web-app-title', content: 'Tulips Are Better' },
...
export const title = 'Tulips Are Better';
